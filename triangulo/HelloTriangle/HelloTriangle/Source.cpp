...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Triangulo feliz!", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(colorLoc, 0.2f, 0.2f, 0.3f, 0.0f); //enviando cor para variável uniform inputColor
